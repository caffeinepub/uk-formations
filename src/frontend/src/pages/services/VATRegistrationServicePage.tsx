    ...
    <div>
      ...
      <Section className="bg-gradient-to-b from-muted/50 to-background pt-12 md:pt-20">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground">
            Register your business for VAT with HMRC quickly and correctly. We
            assess your obligations, advise on the best VAT scheme, and handle
            the entire submission process on your behalf.
          </p>
          {vatService?.pricing && (
      ...
      <Section>
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Navigating VAT registration can be complex. Our experts make it
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Our VAT registration service covers everything from initial
              assessment to receiving your VAT number.
            </p>
          </div>
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Assessment of mandatory vs voluntary registration
                      requirements
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span>
                      Preparation and submission of VAT1 application to HMRC
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span>
                      Liaison with HMRC throughout the registration process
                    </span>
                  </li>
                </ul>
              </CardContent>
      ...
      <Section>
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We help you choose the right VAT scheme to minimise your tax burden
        ...
        <Section className="bg-muted/30">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              One fixed fee covers the entire VAT registration process — no
              hidden charges.
            </p>
            <Card className="border-2 shadow-lg">
              ...
              <CardContent className="space-y-6">
                ...
                <ul className="space-y-3 text-left">
                  {vatService.features.map((feature) => (
      ...
      <Section className="bg-primary text-primary-foreground">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg max-w-2xl mx-auto opacity-90">
            Let our experts handle your VAT registration so you can focus on
            running your business. Contact us today for a free consultation.
          </p>
