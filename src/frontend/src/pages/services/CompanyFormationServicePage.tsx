  ...
  const benefits = [
    {
      ...
      description:
        "Get your company registered within 24-48 hours with our expedited service",
    },
    {
      icon: Shield,
      title: "Fully Compliant",
      description:
        "All formations are fully compliant with Companies House regulations",
    },
    {
      icon: FileText,
      title: "Complete Documentation",
      description:
        "Receive all necessary incorporation documents and certificates",
    },
    {
      icon: CheckCircle2,
  ...
  return (
    <div>
      ...
      <Section className="bg-gradient-to-b from-muted/50 to-background pt-12 md:pt-20">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground">
            Professional UK company registration services for limited companies,
            LLPs, and more. Fast, reliable, and fully compliant with Companies
            House.
          </p>
      ...
      <Section>
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Why Choose Our Formation Service?
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We make company formation simple, fast, and stress-free with our
      ...
      <Section>
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Formation Types We Offer
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We support all major UK business structures to suit your specific
            needs.
          </p>
        </div>
      ...
      <Section className="bg-primary text-primary-foreground">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg max-w-2xl mx-auto opacity-90">
            Start your company formation today and get your business up and
            running in as little as 24 hours.
          </p>
