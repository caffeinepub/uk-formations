  ...
  return (
    <div>
      ...
      <Section className="bg-gradient-to-b from-muted/50 to-background pt-12 md:pt-20">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground">
            Register as an employer with HMRC and set up your PAYE scheme
            correctly from day one. We handle the full registration process,
            provide your employer reference number, and guide you through
            National Insurance and income tax setup.
          </p>
          {payeService?.pricing && (
      ...
      <Section>
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Why Choose Our PAYE Registration Service?
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Setting up PAYE correctly is essential for any employer. Our experts
            ensure a smooth, compliant registration.
          </p>
        </div>
      ...
      <Section className="bg-muted/30">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            How Our PAYE Registration Works
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A simple four-step process to get your employer PAYE scheme up and
            running.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Our PAYE registration service covers everything you need to become
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span>
                      National Insurance setup and contribution guidance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
        ...
        <Section className="bg-muted/30">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              One fixed fee covers the entire PAYE registration process — no
              hidden charges.
            </p>
              ...
              <CardContent className="space-y-6">
                <div className="text-center py-4">
                  ...
                  <p className="text-muted-foreground mt-2">
                    one-off fee, no hidden charges
                  </p>
                </div>
                <ul className="space-y-3 text-left">
                  {payeService.features.map((feature) => (
      ...
      <Section className="bg-primary text-primary-foreground">
        <div className="text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold">
            Ready to Register as an Employer?
          </h2>
          <p className="text-lg max-w-2xl mx-auto opacity-90">
            Let our experts handle your PAYE registration so you can start
            paying your employees correctly and compliantly. Contact us today
