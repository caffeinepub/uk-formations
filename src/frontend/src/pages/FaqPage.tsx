      ...
      <Section className="bg-gradient-to-b from-muted/50 to-background">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Find answers to common questions about UK company formation. Can't
            find what you're looking for? Contact us for help.
          </p>
        </div>
      </Section>
      ...
      <Section className="bg-muted/30">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            Our team is here to help. Get in touch and we will answer any
            questions you have about forming your UK company.
          </p>
