...
export default function HowItWorksPage() {
  ...
  const timeline = [
    ...
    },
    {
      icon: Shield,
      title: 'Complete',
      description: 'Certificate of Incorporation and company documents delivered',
    },
  ];
    ...
    <div>
      <Section className="bg-gradient-to-b from-muted/50 to-background">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">How UK Company Formation Works</h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Our streamlined process makes forming your UK company simple and stress-free. Here is everything
            you need to know.
          </p>
        </div>
      </Section>
      ...
      <Section>
        <h2 className="text-3xl font-bold mb-8 text-center">The Formation Process</h2>
        ...
        <Card className="bg-primary text-primary-foreground border-0">
          <CardHeader className="text-center space-y-4">
            ...
            <CardDescription className="text-primary-foreground/90 text-lg max-w-2xl mx-auto">
              Our formation wizard will guide you through each step. The entire process takes about 15-20
              minutes to complete.
            </CardDescription>
          </CardHeader>
