...
export default function NameCheckPage() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useCheckNameAvailability(searchName, hasSearched);
      ...
      <Section className="bg-gradient-to-b from-muted/50 to-background pt-16 md:pt-24 pb-12">
        <div className="max-w-2xl mx-auto text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Find out if your desired company name is available before starting
            your formation. Enter your proposed company name below to check its
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Enter the full proposed company name including any suffix (e.g.
                Limited, Ltd, LLP).
              </p>
            </div>
          </form>
                ...
                <div className="flex items-start gap-4 p-5 rounded-lg border-2 border-destructive/40 bg-destructive/5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      We were unable to complete the name check. Please try
                      again.
                    </p>
                  </div>
                </div>
                ...
                result.isAvailable ? (
                  <div className="flex items-start gap-4 p-5 rounded-lg border-2 border-blue-500/40 bg-blue-50 dark:bg-blue-950/20">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-3">
                        Great news! You can proceed with this name for your
                        company formation.
                      </p>
                  ...
                  <div className="flex items-start gap-4 p-5 rounded-lg border-2 border-amber-500/40 bg-amber-50 dark:bg-amber-950/20">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-3">
                        Please try a different name. You may want to add a
                        unique word, location, or descriptor to make it
                        distinct.
                      </p>
                    </div>
                  </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div
                key={tip.title}
                className="flex gap-3 p-4 rounded-lg bg-background border"
              >
