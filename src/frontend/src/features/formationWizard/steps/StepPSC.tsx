...
import type { FormationDraft, PSC } from "../formationDraft";
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            or has significant influence over the company. All companies must
            have at least one PSC.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {errors.pscs && (
            <p className="text-sm text-destructive mb-4">{errors.pscs}</p>
          )}
      ...
      {draft.pscs.map((psc, index) => (
        <Card key={psc.id}>
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={psc.firstName}
                  onChange={(e) =>
                    updatePSC(psc.id, { firstName: e.target.value })
                  }
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={psc.lastName}
                  onChange={(e) =>
                    updatePSC(psc.id, { lastName: e.target.value })
                  }
                />
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor={`psc${index}DateOfBirth`}>
                  Date of Birth *
                </Label>
                <Input
                  ...
                  onChange={(e) =>
                    updatePSC(psc.id, { dateOfBirth: e.target.value })
                  }
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updatePSC(psc.id, { nationality: e.target.value })
                  }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={psc.postcode}
                onChange={(e) =>
                  updatePSC(psc.id, { postcode: e.target.value })
                }
