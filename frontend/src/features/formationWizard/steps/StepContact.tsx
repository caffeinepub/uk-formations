...
export default function StepContact({ draft, updateDraft, errors }: StepContactProps) {
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Provide your contact details so we can reach you about your application and send your company
            documents.
          </CardDescription>
        </CardHeader>
      ...
      <Card className="bg-muted/50">
        <CardContent className="pt-6">
          <p className="text-sm text-muted-foreground">
            We will use this information to contact you about your application and to send your Certificate of
            Incorporation and other company documents. Your contact details will not be shared publicly.
          </p>
        </CardContent>
      </Card>
    </div>
