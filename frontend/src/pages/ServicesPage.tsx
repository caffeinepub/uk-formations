  ...
  const categories = [
    {
      ...
      description: 'Professional company registration services for all UK business types',
      icon: Building2,
    ...
    },
    {
      ...
      description: 'Professional business addresses and mail handling solutions',
      icon: MapPin,
    ...
    },
    {
      ...
      description: 'Stay compliant with all UK business regulations and requirements',
      icon: FileCheck,
      ...
      <Section className="bg-gradient-to-b from-muted/50 to-background pt-12 md:pt-20">
        <div className="text-center space-y-6 mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive company formation and business support services to help you start, run, and grow your UK business with confidence.
          </p>
        </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    {services.map((service) => (
                      <div key={service.id} className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
      ...
      <Section className="bg-muted/30">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Choose the perfect package for your business and start your company formation journey today.
          </p>
